...
extern SEXP col_to_rgb_dbl_(SEXP cols_);
...
static const R_CallMethodDef CEntries[] = {
  ...
  {"col_to_rgb_dbl_", (DL_FUNC) &col_to_rgb_dbl_, 1},
...
extern void     col_to_rgb_dbl(const char *col, double  ptr[4]);
...
void R_init_colorfast(DllInfo *info) {
  ...
  R_RegisterCCallable("colorfast", "col_to_rgb_Dbl", (DL_FUNC) &col_to_rgb_dbl);
